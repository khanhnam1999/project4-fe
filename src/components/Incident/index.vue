...
const getListIncidents = async () => {
    // Khi đổi tab nhanh, hủy request cũ để dữ liệu của tab trước
    // không ghi đè lên tab người dùng đang xem.
    ...
    try {
        ...
        // Chỉ request mới nhất được phép cập nhật bảng.
        ...
        // Request bị hủy là hành vi bình thường khi đổi tab,
        // vì vậy không hiển thị thông báo lỗi cho trường hợp này.
